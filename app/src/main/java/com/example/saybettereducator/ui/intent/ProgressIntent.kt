...
sealed class ProgressIntent {
    ...
    data class AddSymbolClicked(val text: String) : ProgressIntent()
    data class TextSymbolAddMode(val isActivating: Boolean) : ProgressIntent()
    data class TextFieldTyping(val text: String) : ProgressIntent()
